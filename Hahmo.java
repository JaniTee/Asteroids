...
public abstract class Hahmo {
    ...
    // Liiku metodissa nyt myös toiminnalisuus, joka tarkistaa mennäänkö rajojen yli.
    public void liiku() {
    ...
    //Tormaako alus asteroidiin, collasion.
    ...
    public Point2D setLiike(Point2D liike) {
        this.liike = liike;
        return this.liike;
    }
    ...
    public void setElossa(boolean vaite) {
        this.elossa = vaite;
    }
